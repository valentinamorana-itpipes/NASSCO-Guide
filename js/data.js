    ...
    groups: [
      {
        title: "Factory (TF)",
        defects: [
          { code: "TF", name: "Tap Factory", desc: "A purpose-made or pre-formed fitting installed during construction, no defects seen. White fittings are commonly used with green PVC, and CAS fittings with DIP — neither needs its own code. To tell factory from break-in, check whether the tap's material matches the host pipe; if it doesn't, assume it's a break-in. A \"Drop Section\" (a new mainline joining the inspected one, usually at 12 or 6 o'clock) can look like a same-size TFA — code it TFA with remark \"Upper Section\" or \"Drop Section\"; if the inspection ends there without reaching a manhole, the last code must be MSA with remark \"TFA Drop Section.\"", photo: "img/codes/tf.jpg" },
          { code: "TFA", name: "Tap Factory Active", desc: "No defects seen, sits flush with the pipe wall, and flow is observed during the inspection. Current flow or staining below the tap is also evidence of activity. VC, VR, or VZ do NOT make the tap defective — code TFA/TBA and note the VC/VR/VZ in Remarks.", photo: "img/codes/tfa.jpg" },
          { code: "TFB", name: "Tap Factory Abandoned", desc: "No longer in use — may be filled with debris or collapsed. Spider-webs across the opening are a common sign it's inactive.", photo: "img/codes/tfb.jpg" },
          { code: "TFC", name: "Tap Factory Capped", desc: "Capped with a fitting or stopper. A well-installed cap shows no defects, fits the tap's size, and looks machine-made. Hand-made caps (often bricks sealed together with concrete/adhesive) are less durable and more prone to damage — still code TFC if no defects are visible. If any defect shows at a capped tap, code TFD/TBD instead, with remark \"Defective cap\" plus the defects seen.", photo: "img/codes/tfc.jpg" },
          { code: "TFD", name: "Tap Factory Defective", desc: "Any defect at the tap or fitting itself — a crack, gap, or damage to the factory fitting — makes it defective. Note the specific defect(s) in Remarks.", photo: "img/codes/tfd.jpg" },
          { code: "TFI", name: "Tap Factory Intruding", desc: "Intrudes into the mainline. Rare except in brick pipe. May carry other defects or observed flow — note in Remarks.", photo: "img/codes/tfi.jpg" }
        ]
      },
      {
        title: "Break-in (TB)",
        defects: [
          { code: "TB", name: "Tap Break-in", desc: "A hole made in the pipe wall to install the tap, aligned evenly with no defects seen. \"Connection\" is the touching point between lateral and main (TF has none, TB does). Square cuts are coded TB with remark \"Square cut\" and are not defective unless gapping or leaking is present.", photo: "img/codes/tb.jpg" },
          { code: "TBA", name: "Tap Break-in Active", desc: "No defects seen, aligned evenly, flow observed during the inspection.", photo: "img/codes/tba.jpg" },
          { code: "TBB", name: "Tap Break-in Abandoned", desc: "No longer in use — may be filled with debris or collapsed. If abandonment can't be confirmed because of other defects present, code TBD instead, with remark \"possibly abandoned\" plus the defects seen.", photo: "img/codes/tbb.jpg" },
          { code: "TBC", name: "Tap Break-in Capped", desc: "Capped with a fitting or stopper. If true defects are present, code TBD instead, with remarks noting the defects plus \"capped.\"", photo: "img/codes/tbc.jpg" },
          { code: "TBD", name: "Tap Break-in Defective", desc: "Any defect at the tap or connection makes it defective — including a gap around the connection, installation against flow, or installation below the springline. Under sanity coding, VC/VR/VZ alone don't make it defective unless paired with a structural defect or ≥10% deposits; NASSCO Pure counts any defect touching the connection or inside the lateral. Square cuts alone don't make a tap defective.", photo: "img/codes/tbd.jpg" },
          { code: "TBI", name: "Tap Break-in Intruding", desc: "Intrudes into the pipe. May carry other defects or observed flow — note in Remarks.", photo: "img/codes/tbi.jpg" }
        ]
      },
      {
        title: "Rehabilitated (TR)",
        defects: [
          { code: "TR", name: "Tap Rehabilitated", desc: "A repaired/rehabilitated tap, no defects seen, aligned evenly with the pipe wall.", photo: "img/codes/tr.jpg" },
          { code: "TRD", name: "Tap Rehabilitated Defective", desc: "The rehabilitated tap shows a defect — damage to the repair material, a gap, or other failure. Note the specific defect(s) in Remarks.", photo: "img/codes/trd.jpg" },
          { code: "TRI", name: "Tap Rehabilitated Intruding", desc: "A repaired/rehabilitated tap intruding into the main by more than 1\".", photo: "img/codes/tri.jpg" }
        ]
      },
      {
        title: "Saddle (TS)",
        defects: [
          { code: "TS", name: "Tap Saddle", desc: "A fitting used to connect and seal the lateral to the inner or outer wall of the main after it was already installed. The rubber gasket seal is almost always black.", photo: "img/codes/ts.jpg" },
          { code: "TSA", name: "Tap Saddle Active", desc: "Aligned evenly with the pipe wall, flow observed during the inspection.", photo: "img/codes/tsa.jpg" },
          { code: "TSB", name: "Tap Saddle Abandoned", desc: "No longer in use — may be filled with debris or collapsed; spider-webs are a common sign.", photo: "img/codes/tsb.jpg" },
          { code: "TSC", name: "Tap Saddle Capped", desc: "Capped with a fitting or stopper. A well-installed cap shows no defects, fits the tap's size, and looks machine-made.", photo: "img/codes/tsc.jpg" },
    ...
    groups: [
      {
        title: "Grout / Other",
        defects: [
          { code: "ISGT", name: "Grout", desc: "Excess grout or concrete squeezed through the joint during grout injection. Mostly found in rigid pipe (VCP, concrete) — grout doesn't stick to metal or plastic. Irregular, \"mountain-like\" shape (unlike the uniform shape of a sealing ring), usually dark grey or beige. In lined pipe, resin intruding from an unexpected cut in the liner can be coded ISGT if the intrusion is >5% and the adhesion clearly failed — confirm with management first.", photo: "img/codes/isgt.jpg" },
          { code: "ISZ", name: "Other", desc: "Sealing material that isn't grout or a sealing ring. Not to be confused with deposits: ISZ is intentionally-placed sealing material that was installed defectively; deposit codes cover unintentional debris caught at the joint. In RPM (truss pipe), adhesive intrusion ≥5% is coded ISZ with remark \"Adhesive.\" Dirt commonly accumulating at PVC joints is NOT sealing material and shouldn't be coded.", photo: "img/codes/isz.jpg" }
        ]
      },
      {
        title: "Sealing Ring (ISSR)",
        defects: [
          { code: "ISSRB", name: "Sealing Ring — Broken", desc: "A black or copper-colored ring, thin, generally following the pipe's circular shape, that has moved away from the joint and does NOT return to it — that's what makes it Broken rather than Hanging. DIP can have sealing rings, but weld failures on DIP usually occur outside the pipe, so they're uncommon to see on inspection.", photo: "img/codes/issrb.jpg" },
          { code: "ISSRH", name: "Sealing Ring — Hanging", desc: "Intrudes into the pipe but re-enters the joint unbroken. Can appear at the invert without necessarily hanging down from an upper clock position.", photo: "img/codes/issrh.jpg" },
          { code: "ISSRL", name: "Sealing Ring — Loose / Poorly Fitting", desc: "Rings are meant to fit snugly between bell and spigot. A loose ring isn't visible until the camera pans.", photo: "img/codes/issrl.jpg" }
        ]
      }
    ]
  },
    ...
    groups: [
      {
        ...
        defects: [
          { code: "ACB", name: "Catch Basin", desc: "An inlet/structure allowing stormwater inflow into the storm sewer. Only switch from AMH to ACB at the start/end of an inspection when the lid is slotted and square/rectangular — a catch-basin-shaped manhole is still coded AMH.", photo: "img/codes/acb.jpg" },
          { code: "ACOH", name: "Cleanout — House", desc: "A cleanout installed on the private side of the service lateral, at or near the building. Looks like a small vertical pipe stub with a screw cap, typically found in yards or near foundations.", photo: "img/codes/acoh.jpg" },
          { code: "ACOM", name: "Cleanout — Mainline", desc: "A cleanout installed directly on the mainline (a.k.a. lamp hole), or on a lateral but within the public right-of-way. Looks like a vertical tap the same size as the mainline, usually at the very end of the pipe. ACOM is itself an access point — no MSA is required, and no tap code is needed alongside it. Remarks must include the associated upstream/downstream manhole number.", photo: "img/codes/acom.jpg" },
          { code: "ACOP", name: "Cleanout — Propertyline", desc: "A cleanout installed on the lateral at or near the property line, between the house cleanout and the mainline connection.", photo: "img/codes/acop.jpg" },
          { code: "ADP", name: "Discharge Point", desc: "Where the pipe (normally storm) empties into a stream or other body of water.", photo: "img/codes/adp.jpg" },
          { code: "AEP", name: "End of Pipe", desc: "The pipe ends underground with no manhole, cleanout, or other structure. Weirs are a common structure found near an AEP close to a WWTP — a flat, vertical surface with evenly spaced holes.", photo: "img/codes/aep.jpg" },
          { code: "AJB", name: "Junction Box", desc: "A chamber where two or more pipes join, usually located outside a treatment facility where large-diameter pipes converge.", photo: "img/codes/ajb.jpg" },
          { code: "AM", name: "Meter", desc: "A structure built to house flow measurement equipment. A regular manhole with a flow meter installed is still coded AMH — note the meter in the header's Comments field instead.", photo: "img/codes/am.jpg" },
          { code: "AMH", name: "Manhole", desc: "A man-entry structure for maintenance and inspection access. Inspections MUST start and end at access points unless an MSA is coded. Unmapped access points are common — code them and flag them to team managers regardless. If there's visual confirmation of driving past an access point that the operator didn't call or code, code it yourself and stop the inspection there.", photo: "img/codes/amh.jpg" },
          ...
          { code: "ATC", name: "Tee Connection", desc: "A junction where two or more pipes meet without a typical access structure — often plumbing tees/wyes, so it can look like a 90° or 45° bend from inside. Made of a run (the fitting's main body) and a branch (the intersecting segment). The inspection ends at another pipe with flow; the required clock position marks that pipe's flow direction.", photo: "img/codes/atc.jpg" },
          { code: "AWA", name: "Wastewater Access", desc: "Intermediate access between manholes, at a grade/direction change, or at an end-of-line segment — not large enough for man-entry, but sized for CCTV and cleaning equipment. Also covers temporary access installed for a construction project.", photo: "img/codes/awa.jpg" },
          { code: "AWW", name: "Wet Well", desc: "Access through a pump station wet well, tank, pit, or reservoir — commonly called a \"lift station,\" since pumps lift water from the reservoir into force/trunk mains. Can look manhole-like; don't call it AWW without visual confirmation of pumping equipment or weirs.", photo: "img/codes/aww.jpg" }
        ]
      }
    ]
  },
    ...
    groups: [
      {
        ...
        defects: [
          { code: "MWL", name: "Water Level", desc: "Mandatory at 0 ft after the access point, expressed as % of diameter/height to the nearest 5%. One MWL entry covers changes of up to 10% up or down without needing a new code — only add a new code once the level moves enough to matter (e.g. it climbs to 20% and doesn't fully return). Code 0% only with visual confirmation that no water was present at all.", photo: "img/codes/mwl.jpg" },
          { code: "MWLS", name: "Water Level Sag (S modifier)", desc: "Used only with visual confirmation of a sag — a downward dip that can signal structural issues in the surrounding soil. A sag is still water, not water simply being pushed along by the camera. Recorded as the percentage at the sag's lowest point. Debris-caused water changes (e.g. toilet paper) are NOT sags. A sag can be coded without JOM/JAM support, but a clear elevation change must be visible; poor camera positioning (too low) can create the illusion of deeper water.", photo: "img/codes/mwls.jpg" },
          { code: "MWM", name: "Water Mark", desc: "An obvious mark on the pipe wall showing where water regularly reaches, even though it's not present during the survey. Tracked alongside MWL with the same ≥10% change threshold — mainly used when a project specifically needs data on surcharging pipes.", photo: "img/codes/mwm.jpg" },
          { code: "MSA", name: "Survey Abandoned", desc: "Coded when the operator stops the inspection because of a defect. Must be the last code — nothing follows it. Two codes are required: the cause code, then MSA at the same distance with the cause code in Remarks (e.g. \"4.5 OBR\" then \"4.5 MSA — Remark: OBR\"). If there's no clear cause, use \"Unknown reason.\" A continuous defect extending past the MSA point gets an estimated distance in Remarks, but the closing distance must still land before the MSA.", photo: "img/codes/msa.jpg" }
        ]
      },
      {
        title: "Material, Shape & Lining Changes",
        defects: [
          { code: "MMC", name: "Material Change", desc: "Coded where a material change was part of the original construction — otherwise, consider RPR instead. If asset records list a material that the video contradicts, add an MMC noting the correct material. An RPR is a short section replaced years after installation to fix defects; MMC indicates two materials installed together by original design.", photo: "img/codes/mmc.jpg" },
          { code: "MSC", name: "Shape/Size Change", desc: "Circular pipe: record the nearest inch/10mm in Value Dimension 1. Non-circular: vertical dimension in Value Dimension 1, horizontal in Value Dimension 2. If the shape itself changes (circular to non-circular or vice versa), note the shape code from the header section in Remarks.", photo: "img/codes/msc.jpg" },
    ...
    groups: [
      {
        ...
        defects: [
          { code: "DAE", name: "Encrustation", desc: "A mineral deposit from ongoing groundwater leakage — organic, not man-made. Needs an external source of ingression (a defective joint, fracture, hole, deformation, or defective tap connection); if none of those are visible, DAE probably isn't the right code. Usually shows up together with its source defect and an infiltration code as three separate entries at the same location. In metal pipe, tuberculation is coded as DAE. NASSCO Pure codes at >1%; sanity coding waits for >5%.", photo: "img/codes/dae.jpg" },
          { code: "DAGS", name: "Grease", desc: "A man-made deposit from an external source (kitchens, bathroom products) — never created by soil or nature, so taps/access points are the source to check first. Builds up above the water line in parallel lines, or in a \"shelf\" pattern with round, mountain-like edges; beige/grey/yellowish, similar to candle wax. Use two codes and clock positions for both sides (or a single entry with two clocks in V8). NASSCO Pure codes at ≥1%; sanity coding waits for ≥5%.", photo: "img/codes/dags.jpg" },
          { code: "DAR", name: "Ragging", desc: "Human-made debris (towels, diapers, feminine products, toilet paper) caught on a defect or sewer component. Sanitary debris is expected in sanitary sewers, so it doesn't always need coding — code it once it's created a real problem: significant mass, snagged on something, or obstructing flow. If it points to surcharging, add MGO \"evidence of surcharging.\"", photo: "img/codes/dar.jpg" },
          { code: "DAZ", name: "Other", desc: "Unclassified attached deposits — remarks mandatory (e.g. \"Unknown deposit\"). Also used for cockroach nests (remark \"Cockroach nest\"), non-DAGS scale/slime layers (remark \"Slime layer\"), and in V8, metal-pipe tuberculation. Sanity coding waits for ≥5%; NASSCO Pure codes at any %.", photo: "img/codes/daz.jpg" }
        ]
      },
      {
        title: "Deposits — Ingress (DN)",
        defects: [
          { code: "DNF", name: "Fine", desc: "Fine particulate (soil, sand, mud) washed in from a pipe defect, settling at the bottom — the clue that separates it from DSF is a clear defect it's ingressing through (e.g. a hole or tap). With no visible external origin, DSF is the better code instead.", photo: "img/codes/dnf.jpg" },
          { code: "DNGV", name: "Gravel", desc: "Small pebble-like rocks washed in from a defect.", photo: "img/codes/dngv.jpg" },
          { code: "DNZ", name: "Other", desc: "Ingressing deposits not classified by the other descriptors.", photo: "img/codes/dnz.jpg" }
        ]
      },
      {
        title: "Deposits — Settled (DS)",
        defects: [
          { code: "DSC", name: "Hard/Compacted", desc: "Hardened or compacted debris (e.g. spilled, cured concrete), dense and structurally bound — firm or solid whether wet or dry, low porosity, and will physically stop the camera from riding over it. Contrast with DSF: DSF is loose, easily disturbed, and porous, even when it looks solidified.", photo: "img/codes/dsc.jpg" },
          { code: "DSF", name: "Fine", desc: "Fine particulate settled in the invert — can look muddy or fluid, especially once the water turns from clear to brown and \"heavy.\" Wait for clear visual evidence and confirmed circumferential loss before coding deposits underwater.", photo: "img/codes/dsf.jpg" },
          { code: "DSGV", name: "Gravel", desc: "Small pebble-like rocks settled in the invert.", photo: "img/codes/dsgv.jpg" },
          { code: "DSZ", name: "Other", desc: "Unclassified deposit settled in the invert.", photo: "img/codes/dsz.jpg" }
        ]
      },
      {
        title: "Grout Test and Seal (G)",
        defects: [
          { code: "GRT", name: "At a Location", desc: "Coded at the time of the grouting procedure itself, at a specific location.", photo: "img/codes/grt.jpg" },
      ...
      },
      {
        ...
        defects: [
          { code: "ISB", codeV6: "IS", nameV6: "Stain", descV6: "Dry at the time of inspection — evidence of past infiltration, not current moisture. V6 has no location modifier — all Stain locations fall under one generic IS code.", name: "Stain, Barrel", desc: "Dry at the time of inspection — the discoloration is evidence of past infiltration, not current moisture.", photo: "img/codes/isb.jpg" },
          { code: "ISC", codeV6: "IS", nameV6: "Stain", descV6: "Dry at the time of inspection — evidence of past infiltration, not current moisture. V6 has no location modifier — all Stain locations fall under one generic IS code.", name: "Stain, Connection", desc: "Dry at the time of inspection — discoloration around a tap connection, evidence of past infiltration there rather than current moisture.", photo: "img/codes/isc.jpg" },
          { code: "ISJ", codeV6: "IS", nameV6: "Stain", descV6: "Dry at the time of inspection — evidence of past infiltration, not current moisture. V6 has no location modifier — all Stain locations fall under one generic IS code.", name: "Stain, Joint", desc: "Dry at the time of inspection. Look for a triangle-shaped stain at the joint; without that shape, it could just be dirt.", photo: "img/codes/isj.jpg" },
          { code: "ISL", codeV6: "IS", nameV6: "Stain", descV6: "Dry at the time of inspection — evidence of past infiltration, not current moisture. V6 has no location modifier — all Stain locations fall under one generic IS code.", name: "Stain, Lateral", desc: "Dry at the time of inspection — discoloration where a lateral enters the mainline, evidence of past infiltration through a defect in the lateral.", photo: "img/codes/isl.jpg" },
          { code: "IWB", codeV6: "IW", nameV6: "Weeper", descV6: "Wet with no visible moving water. V6 has no location modifier — all Weeper locations fall under one generic IW code.", name: "Weeper, Barrel", desc: "Seeping/weeping moisture along the barrel or pipe wall, with no visible moving water.", photo: "img/codes/iwb.jpg" },
          { code: "IWC", codeV6: "IW", nameV6: "Weeper", descV6: "Wet with no visible moving water. V6 has no location modifier — all Weeper locations fall under one generic IW code.", name: "Weeper, Connection", desc: "Seeping/weeping moisture around a tap connection, with no visible moving water.", photo: "img/codes/iwc.jpg" },
          { code: "IWJ", codeV6: "IW", nameV6: "Weeper", descV6: "Wet with no visible moving water. V6 has no location modifier — all Weeper locations fall under one generic IW code.", name: "Weeper, Joint", desc: "Wet with no visible moving water. If the joint is wet but the surrounding pipe wall is dry, the Pre-Cleaning field doesn't matter here — that field only matters when a flushing nozzle was present or cleaning obviously happened during the inspection (wall visibly wet all the way around).", photo: "img/codes/iwj.jpg" },
          { code: "IWL", codeV6: "IW", nameV6: "Weeper", descV6: "Wet with no visible moving water. V6 has no location modifier — all Weeper locations fall under one generic IW code.", name: "Weeper, Lateral", desc: "Seeping/weeping moisture where a lateral enters the mainline, with no visible moving water.", photo: "img/codes/iwl.jpg" },
          { code: "IDB", codeV6: "ID", nameV6: "Dripper", descV6: "A steady drip. V6 has no location modifier — all Dripper locations fall under one generic ID code.", name: "Dripper, Barrel", desc: "A steady drip along the barrel, typically tied to a structural defect.", photo: "img/codes/idb.jpg" },
          { code: "IDC", codeV6: "ID", nameV6: "Dripper", descV6: "A steady drip. V6 has no location modifier — all Dripper locations fall under one generic ID code.", name: "Dripper, Connection", desc: "A steady drip around a tap connection.", photo: "img/codes/idc.jpg" },
          { code: "IDJ", codeV6: "ID", nameV6: "Dripper", descV6: "A steady drip. V6 has no location modifier — all Dripper locations fall under one generic ID code.", name: "Dripper, Joint", desc: "A steady drip at the joint — more than a weeper, less than a runner.", photo: "img/codes/idj.jpg" },
          { code: "IDL", codeV6: "ID", nameV6: "Dripper", descV6: "A steady drip. V6 has no location modifier — all Dripper locations fall under one generic ID code.", name: "Dripper, Lateral", desc: "A steady drip where a lateral enters the mainline, through a visible defect in the lateral.", photo: "img/codes/idl.jpg" },
          { code: "IRB", codeV6: "IR", nameV6: "Runner", descV6: "Continuous flow without pressure. V6 has no location modifier — all Runner locations fall under one generic IR code.", name: "Runner, Barrel", desc: "Runs like a faucet along the barrel, but without pressure behind it.", photo: "img/codes/irb.jpg" },
          { code: "IRC", codeV6: "IR", nameV6: "Runner", descV6: "Continuous flow without pressure. V6 has no location modifier — all Runner locations fall under one generic IR code.", name: "Runner, Connection", desc: "Continuous flow without pressure at a tap connection — only used on break-in or intruding taps, since a factory tap (TF) has no connection for it to enter through.", photo: "img/codes/irc.jpg" },
          { code: "IRJ", codeV6: "IR", nameV6: "Runner", descV6: "Continuous flow without pressure. V6 has no location modifier — all Runner locations fall under one generic IR code.", name: "Runner, Joint", desc: "Runs like a faucet at the joint, but without pressure behind it.", photo: "img/codes/irj.jpg" },
          { code: "IRL", codeV6: "IR", nameV6: "Runner", descV6: "Continuous flow without pressure. V6 has no location modifier — all Runner locations fall under one generic IR code.", name: "Runner, Lateral", desc: "Runs like a faucet where a lateral enters the mainline, but without pressure behind it.", photo: "img/codes/irl.jpg" },
          { code: "IGB", codeV6: "IG", nameV6: "Gusher", descV6: "Water forcing its way through a defect and gushing in under pressure. V6 has no location modifier — all Gusher locations fall under one generic IG code.", name: "Gusher, Barrel", desc: "Water forcing its way through a defect and gushing in under pressure.", photo: "img/codes/igb.jpg" },
          { code: "IGC", codeV6: "IG", nameV6: "Gusher", descV6: "Water forcing its way through a defect and gushing in under pressure. V6 has no location modifier — all Gusher locations fall under one generic IG code.", name: "Gusher, Connection", desc: "Water forcing its way in around a tap connection and gushing under pressure.", photo: "img/codes/igc.jpg" },
          { code: "IGJ", codeV6: "IG", nameV6: "Gusher", descV6: "Water forcing its way through a defect and gushing in under pressure. V6 has no location modifier — all Gusher locations fall under one generic IG code.", name: "Gusher, Joint", desc: "Water forcing its way through a joint and gushing in under pressure.", photo: "img/codes/igj.jpg" },
          { code: "IGL", codeV6: "IG", nameV6: "Gusher", descV6: "Water forcing its way through a defect and gushing in under pressure. V6 has no location modifier — all Gusher locations fall under one generic IG code.", name: "Gusher, Lateral", desc: "Water forcing its way in through a visible defect in a lateral and gushing under pressure.", photo: "img/codes/igl.jpg" }
        ]
      },
      {
        title: "Obstacles / Obstructions (OB)",
        defects: [
          { code: "OBB", name: "Brick or Masonry", desc: "Bricks or other masonry causing significant CSL/obstructing flow, typically in the invert.", photo: "img/codes/obb.jpg" },
          { code: "OBC", name: "Through Connection", desc: "An object entering the main through a tap or lateral.", photo: "img/codes/obc.jpg" },
          { code: "OBI", name: "Intruding Through Wall (Cross Bore)", desc: "A utility line (gas, water, fiber, power, telephone) driven through the pipe wall after construction — doesn't look finished, is a public-safety hazard, and must be reported to the owner immediately. Always accompanied by two H codes (or one H with two clock positions) at the points where it meets the pipe wall — that pairing is mandatory.", photo: "img/codes/obi.jpg" },
          { code: "OBJ", name: "Wedged in the Joint", desc: "Any object wedged in the joint, with remarks — except intruding sealing rings/material, which get their own IS codes instead.", photo: "img/codes/obj.jpg" },
          { code: "OBM", name: "Pipe Material in Invert", desc: "Medium-to-large sections of broken pipe lying in the invert — the source hole is typically found upstream.", photo: "img/codes/obm.jpg" },
          { code: "OBN", name: "Construction Debris", desc: "Loose concrete, metal, or wood timbers in the invert, with remarks describing what it is. Hardened concrete from a spill is DSC, not OBN.", photo: "img/codes/obn.jpg" },
          { code: "OBP", name: "External Pipe or Cable", desc: "A hose or deliberately installed cable that doesn't intrude through the wall — typically runs the length of the sewer in the invert.", photo: "img/codes/obp.jpg" },
          { code: "OBR", name: "Rocks", desc: "Rocks larger than gravel, obstructing flow in the invert.", photo: "img/codes/obr.jpg" },
          { code: "OBS", name: "Built into Structure", desc: "An object intentionally built into the pipe structure, looking finished — describe it in remarks.", photo: "img/codes/obs.jpg" },
          { code: "OBZ", name: "Other", desc: "An obstacle not clearly classified by the other descriptors (e.g. a plumber's snake or drain cable).", photo: "img/codes/obz.jpg" }
        ]
      },
      {
        title: "Roots (R)",
        defects: [
          ...
          { code: "RML", name: "Medium, Lateral", desc: "Roots entering the mainline through a service lateral. In V7+, use the L modifier for roots inside a lateral even if the lateral is capped.", photo: "img/codes/rml.jpg" },
          { code: "RBB", name: "Ball, Barrel", desc: "Roots gathered into a mass greater than 50% CSL, growing through a defect in the barrel/wall rather than at a joint.", photo: "img/codes/rbb.jpg" },
          { code: "RBC", name: "Ball, Connection", desc: "Roots gathered into a mass greater than 50% CSL, growing in around a tap connection. Only coded on break-in/saddle/intruding taps, since a factory tap (TF) has no connection for roots to enter through.", photo: "img/codes/rbc.jpg" },
          { code: "RBJ", name: "Ball, Joint", desc: "Roots gathered into a mass greater than 50% CSL, directly at the joint. If RBJ and DAGS are fused into the same mass, split the total CSL between them rather than double-counting (e.g. a 90% mass = 40% RBJ + 50% DAGS, not 90 of each). Continuous defect coding doesn't apply to a defect this severe — only code it once the root ball itself is ≥50%.", photo: "img/codes/rbj.jpg" },
          { code: "RBL", name: "Ball, Lateral", desc: "Roots gathered into a mass greater than 50% CSL, entering the mainline through a service lateral.", photo: "img/codes/rbl.jpg" },
          { code: "RTB", name: "Tap, Barrel", desc: "A single thick, branch-like root, over ½\" (10mm) thick, growing through the barrel/wall rather than at a joint. Check with the team before coding what might actually be a tree branch (obstacle) instead.", photo: "img/codes/rtb.jpg" },
          { code: "RTC", name: "Tap, Connection", desc: "A single thick, branch-like root, over ½\" (10mm) thick, growing in around a tap connection.", photo: "img/codes/rtc.jpg" },
          { code: "RTJ", name: "Tap, Joint", desc: "A single thick, branch-like root, over ½\" (10mm) thick, at the joint — can expand or create new defects on its own. Check the size/thickness before coding, and check with the team before coding what might actually be a tree branch (obstacle) instead. Doesn't need its own code when already covered by a Roots Medium entry.", photo: "img/codes/rtj.jpg" },
          { code: "RTL", name: "Tap, Lateral", desc: "A single thick, branch-like root, over ½\" (10mm) thick, entering the mainline through a service lateral.", photo: "img/codes/rtl.jpg" }
        ]
      },
      {
        title: "Vermin (V)",
        defects: [
          { code: "VC", name: "Cockroach", desc: "Cockroaches or other insects, including spiders. No headcount value is recorded.", photo: "img/codes/vc.jpg" },
          { code: "VR", name: "Rat", desc: "Rats or mice — record the count in Value Dimension 1.", photo: "img/codes/vr.jpg" },
          { code: "VZ", name: "Other", desc: "Any other animal (worm, lizard, snake, frog) — describe it in Remarks.", photo: "img/codes/vz.jpg" }
        ]
      }
    ]
  },
    ...
    groups: [
      {
        ...
        defects: [
          { code: "CC", name: "Crack Circumferential", desc: "Circular in nature, common near joints and manholes. Don't confuse with manufacturing defects also seen near joints — if the break looks too perfect, with even/smooth edges, it's likely manufactured and shouldn't be coded. True cracks appear from external pressure on the pipe.", photo: "img/codes/cc.jpg" },
          { code: "CH2", name: "Crack Longitudinal Hinge, 2", desc: "A hinge-pattern crack affecting 2 of the 4 quadrant positions (12, 3, 6, 9). If one of the longitudinal breaks is open (a Fracture), the whole defect escalates to Fracture Hinge instead.", photo: "img/codes/ch2.jpg" },
          { code: "CH3", name: "Crack Longitudinal Hinge, 3", desc: "A hinge-pattern crack affecting 3 of the 4 quadrant positions (12, 3, 6, 9). If one of the longitudinal breaks is open (a Fracture), the whole defect escalates to Fracture Hinge instead.", photo: "img/codes/ch3.jpg" },
          { code: "CH4", name: "Crack Longitudinal Hinge, 4", desc: "A hinge-pattern crack affecting all 4 quadrant positions (12, 3, 6, 9). If one of the longitudinal breaks is open (a Fracture), the whole defect escalates to Fracture Hinge instead.", photo: "img/codes/ch4.jpg" },
          { code: "CL", name: "Crack Longitudinal", desc: "Runs lengthwise along the pipe axis. Common at joints and taps. A closed breakline with no visible gap.", photo: "img/codes/cl.jpg" },
          { code: "CM", name: "Crack Multiple", desc: "A longitudinal and circumferential break intersecting. If any of the intersecting breaklines is a Fracture, code the whole thing as FM instead. Structural defects from C to X at the same location don't need separate codes — e.g. a CM intersecting an H is coded as H alone, using whichever code has the highest severity.", photo: "img/codes/cm.jpg" },
          { code: "CS", name: "Crack Spiral", desc: "Coded when a crack changes position or \"turns\" — e.g. starts longitudinal, turns circumferential. Commonly starts at a joint and may return to the same joint; typically doesn't travel across joints. A longitudinal that travels between clock positions becomes a spiral.", photo: "img/codes/cs.jpg" }
        ]
      },
      {
        title: "Fractures (F) — visibly open, gap/depth visible",
        defects: [
          { code: "FC", name: "Fracture Circumferential", desc: "Circular, parallel to joints, commonly seen near joints and manholes. If FC appears at every joint with unusually uniform spacing, it's most likely a manufacturing defect and shouldn't be coded.", photo: "img/codes/fc.jpg" },
          { code: "FH2", name: "Fracture Longitudinal Hinge, 2", desc: "A hinge-pattern fracture affecting 2 of the 4 quadrant positions (12, 3, 6, 9). When a fracture pairs with cracks at the other positions, the worse defect (fracture) is what's reported — a combination of an FL and a CL becomes a Fracture Hinge, but an FM at the location doesn't qualify. If it causes the rigid pipe to go out-of-round, escalate to Deformed (DR).", photo: "img/codes/fh2.jpg" },
          { code: "FH3", name: "Fracture Longitudinal Hinge, 3", desc: "A hinge-pattern fracture affecting 3 of the 4 quadrant positions (12, 3, 6, 9). Same escalation and grading logic as FH2/FH4. If it causes the rigid pipe to go out-of-round, escalate to Deformed (DR).", photo: "img/codes/fh3.jpg" },
          { code: "FH4", name: "Fracture Longitudinal Hinge, 4", desc: "A hinge-pattern fracture affecting all 4 quadrant positions (12, 3, 6, 9) — the full circumference. Same escalation logic as FH2/FH3. If it causes the rigid pipe to go out-of-round, escalate to Deformed (DR).", photo: "img/codes/fh4.jpg" },
          { code: "FL", name: "Fracture Longitudinal", desc: "Runs lengthwise along the pipe axis, common at joints and taps. The breakline is visibly open, revealing a gap — that openness is what separates a Fracture from a Crack.", photo: "img/codes/fl.jpg" },
          { code: "FM", name: "Fracture Multiple", desc: "Where fractures intersect each other, or a fracture intersects a crack — the whole defect is coded FM.", photo: "img/codes/fm.jpg" },
          { code: "FS", name: "Fracture Spiral", desc: "A single fracture that travels both longitudinally and circumferentially, changing position or \"turning.\" Typically starts at a joint and may return to it; typically doesn't cross joints.", photo: "img/codes/fs.jpg" }
        ]
      },
      {
        title: "Broken (B)",
        defects: [
          { code: "B", name: "Broken", desc: "Pipe wall has visibly moved from its original position. V6 threshold: at least ½ pipe wall thickness displaced. V7/V8 threshold: approximately ¼ pipe wall thickness.", photo: "img/codes/b.jpg" },
          { code: "BSV", name: "Broken, Soil Visible", desc: "Pipe wall has moved and soil is visible in the gap, but hasn't eroded away yet.", photo: "img/codes/bsv.jpg" },
          { code: "BVV", name: "Broken, Void Visible", desc: "Pipe wall has moved and is not yet missing, but a void/cavity is visible — soil has eroded away outside the pipe.", photo: "img/codes/bvv.jpg" }
        ]
      },
      {
        title: "Hole (H)",
        defects: [
          { code: "H", name: "Hole", desc: "Pipe material is missing — a small amount of wall gone, with no soil or void present. When an extremely large H/HSV/HVV shows up in a lateral near the main or at the connection, identify it as a defective tap with an appropriate remark, and also code the hole on the main.", photo: "img/codes/h.jpg" },
          { code: "HSV", name: "Hole, Soil Visible", desc: "Pipe wall is missing and soil is visible in the gap, but hasn't eroded away yet.", photo: "img/codes/hsv.jpg" },
          { code: "HVV", name: "Hole, Void Visible", desc: "Pipe wall is missing and a void/cavity is visible, indicating soil has eroded away outside the pipe. Any broken/fracture/crack touching the hole gets coded too.", photo: "img/codes/hvv.jpg" }
        ]
      },
      {
        title: "Deformed / Buckling (D)",
        defects: [
          { code: "DFBI", codeV6: "KI", name: "Deformed Flexible, Bulging Inverse Curvature", desc: "An inward bulge with a sharp crest — can look like a heart or a fin, distinct from a rounded bulge.", photo: "img/codes/dfbi.jpg" },
          { code: "DFBR", codeV6: "KD / LFBU", nameV6: "Dimpling (KD) / Bulges (LFBU)", descV6: "Two distinct V6 causes, both coded DFBR from V7 onward. KD — Dimpling: a wavy pattern or inward bulging in the inner pipe wall, from local instability of the wall itself. LFBU — Bulges: the host pipe has an intruding defect (a break, a tap) that, once the liner is placed over it, pushes the liner outward into a bulge at that spot.", name: "Deformed Flexible, Bulging Round", desc: "One or more rounded projections into the pipe. Can resemble dimpling in RPM/PVC.", photo: "img/codes/dfbr.jpg" },
          { code: "DFC", codeV6: "KW", nameV6: "Buckling Wall", descV6: "Original shape visibly compressed. V6's generic Buckling Wall (KW) code had no grade, and covered both what V7/V8 later split into Creasing (DFC) and Elliptical (DFE).", name: "Deformed Flexible, Creasing", desc: "Sharp outward folding of the pipe wall.", photo: "img/codes/dfc.jpg" },
          { code: "DFE", codeV6: "KW", nameV6: "Buckling Wall", descV6: "Original shape visibly compressed. V6's generic Buckling Wall (KW) code had no grade, and covered both what V7/V8 later split into Creasing (DFC) and Elliptical (DFE).", name: "Deformed Flexible, Elliptical", desc: "Original circular shape visibly compressed into an oval. Graded by CSL in V7/V8: ≤5% = Grade 2, >5–10% = Grade 3, >10–20% = Grade 4, >20–40% = Grade 5.", photo: "img/codes/dfe.jpg" },
          { code: "DH", noV7: true, name: "Deformed Horizontally", desc: "Pressure at 9 and 3 o'clock forces 12 and 6 to bow outward. V6 code.", photo: "img/codes/dh.jpg" },
          { code: "DR", noV6: true, name: "Deformed Rigid", desc: "Pipe wall has moved and is broken/cracked, original shape visibly compressed. Other structural defects present at the location don't need separate coding, but O&M defects still do. Only used up to 40% CSL — beyond that (e.g. 45%) it's Collapse (X). % of CSL lost sets the severity grade: ≤5% = Grade 4, >5% = Grade 5.", photo: "img/codes/dr.jpg" },
          { code: "DTBI", noV6: true, name: "Deformed Brick, Bulging Inverse Curvature", desc: "An inward bulge with a sharp crest in a brick sewer's wall — can look like a heart or a fin, distinct from a rounded bulge.", photo: "img/codes/dtbi.jpg" },
          { code: "DTBR", noV6: true, name: "Deformed Brick, Bulging Round", desc: "One or more rounded projections into a brick sewer's wall.", photo: "img/codes/dtbr.jpg" },
          { code: "DV", noV7: true, name: "Deformed Vertically", desc: "Pressure at 12 and 6 o'clock forces 9 and 3 to bow outward. V6 code.", photo: "img/codes/dv.jpg" }
        ]
      },
      {
        title: "Collapse (X)",
        defects: [
          { code: "X", noV6: true, name: "Collapse", desc: "Complete loss of structural integrity — greater than 40% cross-sectional area lost, flow conveyance completely disrupted. No descriptors, modifiers, joint, or clocks apply; value is CSL % (≥45%). Does NOT use Continuous Defect. V7+ dropped the V6 brick/pipe split back into one generic code.", photo: "img/codes/x.jpg" },
          { code: "XB", noV7: true, name: "Collapse, Brick", desc: "Complete loss of structural integrity in a brick sewer — greater than 40% cross-sectional area lost, flow conveyance completely disrupted. No descriptors, modifiers, joint, or clocks apply; value is CSL % (>40%). Does NOT use Continuous Defect. V6 code.", photo: "img/codes/xb.jpg" },
          { code: "XP", noV7: true, name: "Collapse, Pipe", desc: "Complete loss of structural integrity in a pipe sewer — greater than 40% cross-sectional area lost, flow conveyance completely disrupted. No descriptors, modifiers, joint, or clocks apply; value is CSL % (>40%). Does NOT use Continuous Defect. V6 code.", photo: "img/codes/xp.jpg" }
        ]
      },
      {
        title: "Joints — defective displacements",
        defects: [
          { code: "JAL", name: "Joint Angular Large", desc: "Out of alignment more than 10°. Caused by pipe movement (usually lost support), unintentionally changing flow direction — shown as left-right snaking of the pipe visible in the flow.", photo: "img/codes/jal.jpg" },
          { code: "JAM", name: "Joint Angular Medium", desc: "Out of alignment more than 5°, up to 10°. Caused by pipe movement (usually lost support), unintentionally changing flow direction — shown as left-right snaking of the pipe visible in the flow.", photo: "img/codes/jam.jpg" },
          ...
          { code: "JOMD", noV6: true, name: "Joint Offset Medium, Defective", desc: "A Joint Offset Medium (JOM) displaced enough to disrupt flow — doesn't exist in V6. Whether the Defective modifier applies depends on whether the offset is actually disrupting water flow.", photo: "img/codes/jomd.jpg" },
          { code: "JOS", name: "Joint Offset Small", desc: "Displaced less than 1x pipe wall thickness — a minor offset, not yet significant enough to reach Medium.", photo: "img/codes/jos.jpg" },
          { code: "JOSD", noV6: true, name: "Joint Offset Small, Defective", desc: "A Joint Offset Small (JOS) displaced enough to disrupt flow — doesn't exist in V6. Whether the Defective modifier applies depends on whether the offset is actually disrupting water flow.", photo: "img/codes/josd.jpg" },
          { code: "JSL", name: "Joint Separated Large", desc: "Gap ≥1.5x pipe wall thickness between joints, with evidence of gasket displacement (gasketed systems). Bell-and-spigot: the spigot has pulled back out of the bell — look for an exposed/twisted/missing gasket or a visible gap at the insertion mark. Non-bell-and-spigot (couplers/slip/butt joints): the ends have separated within, or pulled apart from, the coupling. Code JSL with a 90° full-circumference pan confirming the bell is NOT touching the spigot, OR (with no pan) when infiltration/soil/debris ingress confirms it, and the gap is ≥1.5x wall thickness. Don't code JSL if the bell is still visibly touching the spigot. Add HSV/HVV alongside JSL only when the resulting void is significant — a cavern, the full exterior visible through the joint, daylight/running water visible, or a void large enough to risk soil infiltration/settlement/subsidence; ingressing soil/debris through a JSL is a good trigger too. If a separated joint was already repaired from the outside and the repair is visible on pan, don't code JSL — code the RPR only, since it indicates the JSL was already rehabbed.", photo: "img/codes/jsl.jpg" },
          { code: "JSM", name: "Joint Separated Medium", desc: "Separated up to 1x pipe wall thickness.", photo: "img/codes/jsm.jpg" },
          { code: "JSS", name: "Joint Separated Small", desc: "A minor gap between joints, less than what qualifies as Medium — evidence of gasket displacement (gasketed systems) without a significant separation yet.", photo: "img/codes/jss.jpg" }
        ]
      },
      {
        title: "Surface Damage (S)",
        defects: [
          { code: "SAM", noV6: true, name: "Aggregate Missing", desc: "Aggregate has fallen out, leaving small pits in the wall. Concrete pipes only.", photo: "img/codes/sam.jpg" },
          { code: "SAMC", noV7: true, name: "Aggregate Missing, Chemical", desc: "Aggregate has fallen out from H2S/chemical attack, leaving small pits in the wall. Concrete pipes only. V6 modifier variant of Aggregate Missing.", photo: "img/codes/samc.jpg" },
          { code: "SAMM", noV7: true, name: "Aggregate Missing, Mechanical", desc: "Aggregate has fallen out from physical/mechanical damage rather than chemical attack, leaving small pits in the wall. Concrete pipes only. V6 modifier variant of Aggregate Missing.", photo: "img/codes/samm.jpg" },
          { code: "SAMZ", noV7: true, name: "Aggregate Missing, Unknown", desc: "Aggregate has fallen out, leaving small pits in the wall, with no clear evidence of chemical or mechanical cause. Concrete pipes only. V6 modifier variant of Aggregate Missing.", photo: "img/codes/samz.jpg" },
          { code: "SAP", noV6: true, name: "Aggregate Projecting", desc: "Aggregate projecting but not yet missing. Concrete pipes only.", photo: "img/codes/sap.jpg" },
          { code: "SAPC", noV7: true, name: "Aggregate Projecting, Chemical", desc: "Aggregate projecting from H2S/chemical attack, but not yet missing. Concrete pipes only. V6 modifier variant of Aggregate Projecting.", photo: "img/codes/sapc.jpg" },
          { code: "SAPM", noV7: true, name: "Aggregate Projecting, Mechanical", desc: "Aggregate projecting from physical/mechanical damage, but not yet missing. Concrete pipes only. V6 modifier variant of Aggregate Projecting.", photo: "img/codes/sapm.jpg" },
          { code: "SAPZ", noV7: true, name: "Aggregate Projecting, Unknown", desc: "Aggregate projecting but not yet missing, with no clear evidence of chemical or mechanical cause. Concrete pipes only. V6 modifier variant of Aggregate Projecting.", photo: "img/codes/sapz.jpg" },
          { code: "SAV", noV6: true, name: "Aggregate Visible", desc: "Aggregate visible but not yet projecting. Concrete pipes only.", photo: "img/codes/sav.jpg" },
          { code: "SAVC", noV7: true, name: "Aggregate Visible, Chemical", desc: "Aggregate visible from H2S/chemical attack, but not yet projecting. Concrete pipes only. V6 modifier variant of Aggregate Visible.", photo: "img/codes/savc.jpg" },
          { code: "SAVM", noV7: true, name: "Aggregate Visible, Mechanical", desc: "Aggregate visible from physical/mechanical damage, but not yet projecting. Concrete pipes only. V6 modifier variant of Aggregate Visible.", photo: "img/codes/savm.jpg" },
          { code: "SAVZ", noV7: true, name: "Aggregate Visible, Unknown", desc: "Aggregate visible but not yet projecting, with no clear evidence of chemical or mechanical cause. Concrete pipes only. V6 modifier variant of Aggregate Visible.", photo: "img/codes/savz.jpg" },
          { code: "SCP", name: "Corrosion", desc: "Metal pipe only — the pipe is still intact but appears rusted. Requires all three: coating has deteriorated, the pipe shows a rusty color and rough texture, AND the corrosion has changed the surface's texture/volume/depth. Color or texture alone isn't enough. Builds up and flakes off over time; DAE can occur alongside SCP, and SSC/SSS often precede it when the damage is less severe. No M/C/Z modifiers are used on SCP in any version.", photo: "img/codes/scp.jpg" },
          { code: "SMW", noV6: true, name: "Missing Wall", desc: "Wall has completely eroded away, with smooth edges — distinct from a Hole, where wall thickness stays consistent at the edges. SMW forms gradually from corrosion/H2S attack, leaving thinner, more uneven edges. Applies to all pipe types affected by H2S.", photo: "img/codes/smw.jpg" },
          { code: "SMWC", noV7: true, name: "Missing Wall, Chemical", desc: "Wall has completely eroded away from H2S/chemical attack, with smooth, thinner edges — distinct from a Hole, where wall thickness stays consistent. V6 modifier variant of Missing Wall.", photo: "img/codes/smwc.jpg" },
          { code: "SMWM", noV7: true, name: "Missing Wall, Mechanical", desc: "Wall has completely eroded away from physical/mechanical damage rather than chemical attack. V6 modifier variant of Missing Wall.", photo: "img/codes/smwm.jpg" },
          { code: "SMWZ", noV7: true, name: "Missing Wall, Unknown", desc: "Wall has completely eroded away, with no clear evidence of chemical or mechanical cause. V6 modifier variant of Missing Wall.", photo: "img/codes/smwz.jpg" },
          { code: "SRC", noV6: true, name: "Reinforcement Corroded", desc: "Reinforcement/rebar is corroding or deteriorating, and may be missing in places. Reinforced concrete only.", photo: "img/codes/src.jpg" },
          { code: "SRCC", noV7: true, name: "Reinforcement Corroded, Chemical", desc: "Rebar is corroding from H2S/chemical attack, and may be missing in places. Reinforced concrete only. V6 modifier variant of Reinforcement Corroded.", photo: "img/codes/srcc.jpg" },
          { code: "SRCM", noV7: true, name: "Reinforcement Corroded, Mechanical", desc: "Rebar is deteriorating from physical/mechanical damage rather than chemical attack. Reinforced concrete only. V6 modifier variant of Reinforcement Corroded.", photo: "img/codes/srcm.jpg" },
          { code: "SRCZ", noV7: true, name: "Reinforcement Corroded, Unknown", desc: "Rebar is corroding or deteriorating, with no clear evidence of chemical or mechanical cause. Reinforced concrete only. V6 modifier variant of Reinforcement Corroded.", photo: "img/codes/srcz.jpg" },
          { code: "SRI", noV6: true, name: "Roughness Increased", desc: "Surface slightly worn, abraded, or deteriorated. Concrete pipes only.", photo: "img/codes/sri.jpg" },
          { code: "SRIC", noV7: true, name: "Roughness Increased, Chemical", desc: "Surface slightly worn or deteriorated from H2S/chemical attack. Concrete pipes only. V6 modifier variant of Roughness Increased.", photo: "img/codes/sric.jpg" },
          { code: "SRIM", noV7: true, name: "Roughness Increased, Mechanical", desc: "Surface slightly worn or abraded from physical/mechanical damage rather than chemical attack. Concrete pipes only. V6 modifier variant of Roughness Increased.", photo: "img/codes/srim.jpg" },
          { code: "SRIZ", noV7: true, name: "Roughness Increased, Unknown", desc: "Surface slightly worn, abraded, or deteriorated, with no clear evidence of chemical or mechanical cause. Concrete pipes only. V6 modifier variant of Roughness Increased.", photo: "img/codes/sriz.jpg" },
          { code: "SRP", noV6: true, name: "Reinforcement Projecting", desc: "Serious erosion that fully exposes reinforcement/rebar, now projecting into the pipe. Reinforced concrete only.", photo: "img/codes/srp.jpg" },
          { code: "SRPC", noV7: true, name: "Reinforcement Projecting, Chemical", desc: "Serious H2S/chemical erosion that fully exposes reinforcement/rebar, now projecting into the pipe. Reinforced concrete only. V6 modifier variant of Reinforcement Projecting.", photo: "img/codes/srpc.jpg" },
          { code: "SRPM", noV7: true, name: "Reinforcement Projecting, Mechanical", desc: "Physical/mechanical damage that fully exposes reinforcement/rebar, now projecting into the pipe. Reinforced concrete only. V6 modifier variant of Reinforcement Projecting.", photo: "img/codes/srpm.jpg" },
          { code: "SRPZ", noV7: true, name: "Reinforcement Projecting, Unknown", desc: "Serious erosion that fully exposes reinforcement/rebar, now projecting into the pipe, with no clear evidence of chemical or mechanical cause. Reinforced concrete only. V6 modifier variant of Reinforcement Projecting.", photo: "img/codes/srpz.jpg" },
          { code: "SRV", noV6: true, name: "Reinforcement Visible", desc: "Concrete has eroded enough to expose reinforcement/rebar, with no projection into the pipe. Reinforced concrete only.", photo: "img/codes/srv.jpg" },
          { code: "SRVC", noV7: true, name: "Reinforcement Visible, Chemical", desc: "Concrete has eroded from H2S/chemical attack enough to expose reinforcement/rebar, with no projection into the pipe. Reinforced concrete only. V6 modifier variant of Reinforcement Visible.", photo: "img/codes/srvc.jpg" },
          { code: "SRVM", noV7: true, name: "Reinforcement Visible, Mechanical", desc: "Physical/mechanical damage has exposed reinforcement/rebar, with no projection into the pipe. Reinforced concrete only. V6 modifier variant of Reinforcement Visible.", photo: "img/codes/srvm.jpg" },
          { code: "SRVZ", noV7: true, name: "Reinforcement Visible, Unknown", desc: "Concrete has eroded enough to expose reinforcement/rebar, with no projection into the pipe and no clear evidence of chemical or mechanical cause. Reinforced concrete only. V6 modifier variant of Reinforcement Visible.", photo: "img/codes/srvz.jpg" },
          { code: "SSC", noV6: true, name: "Spalling of Coating", desc: "The interior coating is damaged, abraded, flaked, or splintered — often a spider-web cracking pattern. Used on VCP and other coated pipe.", photo: "img/codes/ssc.jpg" },
          { code: "SSS", noV6: true, name: "Spalling", desc: "Flaking deeper than a coating, mainly on VCP. A chip of wall missing right at the joint is better described as spalling. In V6, modifiers M (Mechanical)/C (Chemical)/Z (Not evident) applied — use M when the spalling edges are too clean/square, indicating machine damage (e.g. a root remover) rather than natural gas attack.", photo: "img/codes/sss.jpg" },
          { code: "SSSC", noV7: true, name: "Spalling, Chemical", desc: "Flaking deeper than a coating, from gas/chemical attack (e.g. H2S) — mainly on VCP. V6 modifier variant of Spalling.", photo: "img/codes/sssc.jpg" },
          { code: "SSSM", noV7: true, name: "Spalling, Mechanical", desc: "Spalling with clean, square-looking edges — indicates machine damage (e.g. a root remover) rather than natural gas/H2S attack. V6 modifier variant of Spalling.", photo: "img/codes/sssm.jpg" },
          { code: "SSSZ", noV7: true, name: "Spalling, Unknown", desc: "Flaking deeper than a coating, mainly on VCP, with no clear evidence of chemical or mechanical cause. V6 modifier variant of Spalling.", photo: "img/codes/sssz.jpg" },
          { code: "SZ", noV6: true, name: "Other", desc: "Any surface damage not covered above. In PVC, overheated joint welds can look melted or show wrinkles/bubbles resembling a lining — code as SZ or ignore. In concrete pipe with chipping at joints, prefer SZ over SSS in most cases, since concrete rarely truly spalls.", photo: "img/codes/sz.jpg" },
          { code: "SZC", noV7: true, name: "Other, Chemical", desc: "Surface damage not covered above, from chemical/H2S attack. V6 modifier variant of Other.", photo: "img/codes/szc.jpg" },
          { code: "SZM", noV7: true, name: "Other, Mechanical", desc: "Surface damage not covered above, from physical/mechanical damage. V6 modifier variant of Other.", photo: "img/codes/szm.jpg" },
          { code: "SZZ", noV7: true, name: "Other, Unknown", desc: "Surface damage not covered above, with no clear evidence of chemical or mechanical cause. V6 modifier variant of Other.", photo: "img/codes/szz.jpg" }
        ]
      },
      {
        title: "Lining Features (LF)",
        defects: [
          { code: "LFAC", name: "Abandoned Connection", desc: "An outward dimple in the liner where it was installed over a now-abandoned connection.", photo: "img/codes/lfac.jpg" },
          { code: "LFAS", name: "Annular Space", desc: "The liner doesn't fit tightly against the host pipe, leaving a visible gap — usually at liner ends near access points, at patch-repair ends, or at a tap connection. Requires visual confirmation of a significant gap.", photo: "img/codes/lfas.jpg" },
          { code: "LFB", name: "Blistered", desc: "Bubbles/raised pockets in the liner's interior coating, caused by trapped air, resin, water, solvent, or excess heat during curing. See LFB vs DFBR: LFB blisters are smaller, dome-shaped, and circular with round edges; DFBR bulges are larger, pushed outward by an intruding defect covered by the liner.", photo: "img/codes/lfb.jpg" },
          { code: "LFBK", noV7: true, name: "Buckled", desc: "The pipe lining has buckled — usually occurs at the top of the pipe. V6 code.", photo: "img/codes/lfbk.jpg" },
          { code: "LFCS", name: "Service Cut Shifted", desc: "The liner has moved or shrunk relative to the tap connection, obstructing it — differs from an occasional undercut/overcut since it will likely affect most or all taps.", photo: "img/codes/lfcs.jpg" },
          { code: "LFD", name: "Detached", desc: "Liner has detached from the host pipe. If sections are hanging/loose at the edge or beginning of the lined section, code RPLD instead and add remarks plus any other defects present.", photo: "img/codes/lfd.jpg" },
          { code: "LFDC", name: "Discoloration", desc: "Abnormal/inconsistent liner color, often from bacteria buildup or water permeation — aging liners can turn orange or reddish. \"Crack-like\" bleeding/staining lines mean moisture outside the liner has bled in and stained it.", photo: "img/codes/lfdc.jpg" },
          { code: "LFDE", name: "Defective End", desc: "The liner's end is ragged, warped, or shrunk.", photo: "img/codes/lfde.jpg" },
          { code: "LFDL", name: "Delamination", desc: "The liner's material layers have separated during installation and are no longer homogeneous.", photo: "img/codes/lfdl.jpg" },
          { code: "LFOC", name: "Overcut Service", desc: "Too much liner cut around a service connection, leaving part of the host pipe unlined. Under normalized coding, LFOC doesn't need an accompanying tap code — but if an H is seen at the connection, add the matching HVV/HSV on the mainline (a TBD may also apply). Tip: if the overcut is covered by a gasket, LFOC isn't needed.", photo: "img/codes/lfoc.jpg" },
          { code: "LFPH", noV7: true, name: "Pinhole (weep points)", desc: "Water drops appearing to fall from the liner; can be black or orange. Sometimes accompanied by an IS (infiltration) code. V6 code.", photo: "img/codes/lfph.jpg" },
          { code: "LFRS", name: "Resin Slug", desc: "Cured resin left in the connection, obstructing flow.", photo: "img/codes/lfrs.jpg" },
          { code: "LFUC", name: "Undercut Service", desc: "The reinstatement cut is too small for the tap diameter, obstructing flow. Normalized coding doesn't require an accompanying tap code.", photo: "img/codes/lfuc.jpg" },
          { code: "LFW", name: "Wrinkle", desc: "Fins / circumferential wrinkling from too much liner material (oversized) or a liner installed on a bend — flow may be disrupted if it sits in the invert. A spiral-looking pattern (a \"splice\") is not a defect and shouldn't be coded. Normalized coding: code once the wrinkle reaches ~5% and sits at/near normal flow. NASSCO Pure codes every wrinkle regardless of size.", photo: "img/codes/lfw.jpg" },
          { code: "LFZ", name: "Other", desc: "Any lining defect not covered above — e.g. detached seam tapes (long, peelable strips, often white or liner-colored, usually minor up to 5% coverage), a liner patch, or scratches. \"MGO: Splice\" in Remarks is used for the spiral-splice pattern noted under LFW.", photo: "img/codes/lfz.jpg" }
        ]
      },
      {
        title: "Weld Failure (WF)",
        defects: [
          { code: "WFC", name: "Weld Failure, Circumferential", desc: "A failed or non-uniform weld running circumferentially — applies to large-diameter, plastic, spiral-wound, butt-fused, metal, or plastic-lined RCP. So rare on gravity sewer inspections that there aren't many field examples — more relevant on pressure pipe. Can't be coded as continuous.", photo: "img/codes/wfc.jpg" },
          { code: "WFL", name: "Weld Failure, Longitudinal", desc: "A failed or non-uniform weld running longitudinally. So rare on gravity sewer inspections that there aren't many field examples — more relevant on pressure pipe. Can be Truly or Repeated Continuous.", photo: "img/codes/wfl.jpg" },
          { code: "WFM", name: "Weld Failure, Multiple", desc: "Multiple failed or non-uniform welds intersecting or occurring together. So rare on gravity sewer inspections that there aren't many field examples — more relevant on pressure pipe. Can be Truly or Repeated Continuous.", photo: "img/codes/wfm.jpg" },
          { code: "WFS", name: "Weld Failure, Spiral", desc: "A failed or non-uniform weld in spiral-wound pipe specifically. So rare on gravity sewer inspections that there aren't many field examples — more relevant on pressure pipe. Can be Truly or Repeated Continuous.", photo: "img/codes/wfs.jpg" },
          { code: "WFZ", name: "Weld Failure, Other", desc: "A weld failure not classified by the other descriptors — remarks required. So rare on gravity sewer inspections that there aren't many field examples — more relevant on pressure pipe. Can be Truly or Repeated Continuous.", photo: "img/codes/wfz.jpg" }
        ]
      },
      {
        ...
        defects: [
          ...
          { code: "RPLD", name: "Liner Defective", desc: "The localized liner repair (RPL) wasn't effective, was damaged during installation, or is otherwise failing — sections hanging or loose at the edges are the most common trigger. Enter the resulting defect codes as new observations.", photo: "img/codes/rpld.jpg" },
          ...
          { code: "RPZ", name: "Other", desc: "A point repair not classified as Liner, Patch, or Replacement — remarks required. In V6/V7 this also covered what V8 split out as its own RPM (Mechanical Sleeve) code; note the method/material in Remarks (e.g. \"mechanical sleeve\").", photo: "img/codes/rpz.jpg" },
          { code: "RPZD", name: "Other Defective", desc: "The point repair method itself doesn't fit Liner, Patch, or Replacement — remarks required — and it's failing or damaged. Enter the resulting defect codes as new observations.", photo: "img/codes/rpzd.jpg" }
        ]
      },
      {
        title: "Anchor Holes",
        defects: [
          ...
          { code: "RPP", name: "Healthy Anchor Hole", desc: "Healthy anchor holes do not need to be coded individually — the initial MGO is enough.", photo: "img/codes/rpp-2.jpg" },
          { code: "RPPD", name: "Defective Anchor Hole", desc: "An anchor hole is considered defective if any defect is touching it or the patch and it allows the ingress of water, roots, or soil. If the object used for sealing is intruding into the manhole (e.g. a brick), add a remark stating the material or object. Add the accompanying defect in the mainline as a separate code (CL, RFB, ISB, etc.).", photo: "img/codes/rppd-2.jpg" }
        ]
      },
      {
        title: "Brick Work — brick & clay tile sewers only",
        defects: [
          { code: "DB", name: "Displaced Brick", desc: "One or more bricks have shifted from their original position but haven't fallen.", photo: "img/codes/db.jpg" },
          { code: "DI", name: "Dropped Invert", desc: "Brickwork at the invert has separated/dropped relative to the sewer walls, with a gap greater than 1\". May affect one or both sides — estimate the gap to the nearest ½\".", photo: "img/codes/di.jpg" },
          { code: "MB", name: "Missing Brick", desc: "One or more bricks are missing/have fallen away, possibly across more than one course.", photo: "img/codes/mb.jpg" },
          { code: "MML", name: "Missing Mortar, Large", desc: "Mortar — the sand/water/cement mix that binds bricks and seals joints — has receded more than 2\" while the bricks are still in place. Truly Continuous applies if the defect is >3 ft (1 m); Repeated Continuous is NOT applicable to brickwork.", photo: "img/codes/mml.jpg" },
          { code: "MMM", name: "Missing Mortar, Medium", desc: "Mortar has receded ½–2\" while the bricks are still in place. Truly Continuous applies if the defect is >3 ft (1 m); Repeated Continuous is NOT applicable to brickwork.", photo: "img/codes/mmm.jpg" },
          { code: "MMS", name: "Missing Mortar, Small", desc: "Mortar has receded less than ½\" while the bricks are still in place. Truly Continuous applies if the defect is >3 ft (1 m); Repeated Continuous is NOT applicable to brickwork.", photo: "img/codes/mms.jpg" }
        ]
      }
    ]
  }
