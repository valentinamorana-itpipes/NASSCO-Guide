    ...
    groups: [
      ...
      },
      {
        ...
        defects: [
          ...
          { code: "DFBR", codeV6: "KD / LFBU", name: "Deformed Flexible, Bulging Round", desc: "One or more rounded projections into the pipe. V6 had no grade for this — called KD on a raw pipe wall, or LFBU (\"Small Bumps\") when the bulge is on a liner. Can resemble dimpling in RPM/PVC." },
      ...
      },
      {
        ...
        defects: [
          ...
          { code: "LFBK", noV7: true, name: "Needs confirmation", desc: "V6-only lining code — not covered by any of the source decks used to build this guide. Placeholder until confirmed; please share what LFBK means so this can be filled in correctly." },
          ...
          { code: "LFPH", noV7: true, name: "Pinhole (weep points)", desc: "Water drops appearing to fall from the liner; can be black or orange. Sometimes accompanied by an IS (infiltration) code. V6 code." },
