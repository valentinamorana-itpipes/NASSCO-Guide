    ...
    groups: [
      ...
      },
      {
        ...
        defects: [
          ...
          { code: "MY", name: "Dye Test", desc: "Coded when the survey coincides with a dye test (checking cross-connections, I/I sources, or specific building connections). Modifiers: V (Visible — record the dye color and details in Remarks) or N (Not Visible — test conducted but dye wasn't seen).", photo: "img/codes/my.jpg" }
        ]
      }
    ]
  },
